...
for(w in c(2000,10000,50000,100000)){
  ...
  tissue_plot <- get_facet_plot(df = feature_data[which(feature_data$study %in% studies_with_blood),], 
                                yvar = "cluster_closest_genes", title = "Cluster signature",
                                comparison_categ = "tissue")[[2]]
  print(tissue_plot)
  ...
  print(get_facet_plot(df = feature_data, yvar = "cluster_closest_genes", title = "Cluster signature")[[1]])
  ...
  subtype_plot <- get_facet_plot(df = feature_data, yvar = "cluster_closest_genes", title = "Cluster signature")[[2]]
  print(subtype_plot)
...
for(w in c(2000,10000,50000,100000)){
  ...
  subtype_plot <- get_facet_plot(df = feature_data, yvar = "cluster_closest_genes", title = "Cluster signature")[[1]]
  print(subtype_plot)
  ...
  print(get_facet_plot(df = feature_data, yvar = "cluster_closest_genes", title = "Cluster signature")[[2]])
  print(get_facet_plot(df = feature_data, yvar = "Random_genes", title = "Random signature")[[2]])
  dev.off()
