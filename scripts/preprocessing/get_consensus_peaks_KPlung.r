...
conditions <- c("Healthy blood", "KP blood", "Healthy lung", "KP lung SiglecF-lo", "KP lung SiglecF-hi",
                "Healthy blood", "KP blood", "Healthy lung", "KP lung SiglecF-lo", "KP lung SiglecF-hi", "KP lung SiglecF-hi",
                "Healthy blood", "KP blood", "Healthy lung", "KP lung SiglecF-lo", "KP lung SiglecF-hi", "Healthy blood",
                "KP blood", "Healthy lung", "KP lung SiglecF-lo")
conditions <- plyr::revalue(conditions, c("Healthy blood" = "Healthy_blood", 
                                          "KP blood" = "KP_blood", 
                                          "Healthy lung" = "Healthy_lung", 
                                          "KP lung SiglecF-lo" = "KP_lung_SiglecF_low", 
                                          "KP lung SiglecF-hi"= "KP_lung_SiglecF_high"))
names(conditions) <- paste0(c("C1", "C2", "C3", "C4",
                              "C5","C6", "C7", "C8", "C9", "C10" , "C15",
                              "C16", "C17", "C18", "C19", "C20", "C21", "C22", "C23", "C24"), "_Pittet_ME")
samples$groups = conditions[samples$sample_name] 

batch_association <- c("C1_Pittet_ME"="batch1", "C2_Pittet_ME"="batch1", "C3_Pittet_ME"="batch1", "C4_Pittet_ME"="batch1", "C5_Pittet_ME"="batch1", 
                       "C6_Pittet_ME"="batch2", "C7_Pittet_ME"="batch2", "C8_Pittet_ME"="batch2", "C9_Pittet_ME"="batch2", "C10_Pittet_ME"="batch2", 
                       "C15_Pittet_ME"="batch3", 
                       "C16_Pittet_ME"="batch4", "C17_Pittet_ME"="batch4", "C18_Pittet_ME"="batch4", "C19_Pittet_ME"="batch4", "C20_Pittet_ME"="batch4", 
                       "C21_Pittet_ME"="batch5", "C22_Pittet_ME"="batch5", "C23_Pittet_ME"="batch5", "C24_Pittet_ME"="batch5")
samples$batch <- batch_association[samples$sample_name] 
